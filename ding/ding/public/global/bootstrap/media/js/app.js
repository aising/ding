...
var App = function () {
    ...
    var handleSidebarMenu = function () {
		...
		// 	if($(this).next().hasClass('sub-menu') == false){
		// 		$(this).parents(".page-sidebar-menu").find(".active").removeClass("active");
		// 		$(this).parent().addClass("active");
				
		// 		/*if($(this).parent().parent().hasClass("page-sidebar-menu") == false){
		// 			$(this).parent().parent().parent().addClass("active")
		// 		}*/
		// 		$(this).parents("li").addClass("active");
		// 		$(".page-title").html($(this).text());
		// 		var crumbs = '<li><i class="icon-home"></i><a href="index.html">Home</a><i class="icon-angle-right"></i></li>';
		// 		$(this).parents(".page-sidebar-menu").find(".active").each(function(){
		// 			var aObj = $(this).children("a");
		// 			crumbs += '<li><a href="'+aObj.attr("href")+'">'+aObj.text()+'</a><i class="icon-angle-right"></i></li>';
		// 		});
		// 		crumbs = crumbs.replace(/<i class="icon-angle-right"><\/i><\/li>$/,"</li>");
